package com.tao.hotel.fragment;
...
import com.tao.hotel.adapter.OrderAdapter;
...
public class NowFragment extends Fragment {
    ...
    @BindView(R.id.rv_now_fragment)
    RecyclerView rvNowFragment;
    Unbinder unbinder;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvNowFragment.setAdapter(adapter);
        rvNowFragment.setLayoutManager(new LinearLayoutManager(getActivity()));
    }
